...
public class CopySwipeDragHelper extends ItemTouchHelper.Callback {
    ...
    private CopySwipeDragHelper(RecyclerView recyclerView, SwipeDragActionListener contract) {
     ...
     */
    public static CopySwipeDragHelper Builder(RecyclerView recyclerView, SwipeDragActionListener adapter) {
        return new CopySwipeDragHelper(recyclerView, adapter);
    }
...
//    }
    ...
    public CopySwipeDragHelper setEnableSwipeOption(boolean isEnableSwipeOption) {
        this.isEnableSwipeOption = isEnableSwipeOption;
        return this;
    }

    public CopySwipeDragHelper setEnableResetSavedList(String versionName) {
